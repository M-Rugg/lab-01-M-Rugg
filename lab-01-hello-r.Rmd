...
```
**r = -0.0629611**
The `r` for `star` is just slightly larger than the the `r` for `dino`. However, they are both negative and within 0.0015 of each other.
...
```
**r = -0.06834336**
The `r` of `circle` is slightly smaller than the `r` of `dino`. They are both negative.
